...
PROYECT_PATH = os.path.join(SETTINGS_DIR, os.pardir)
...
MEDIA_ROOT = os.path.join(PROYECT_PATH, 'media')
...
SECRET_KEY = '6^c5^d&_*d7%90+)&p$#c6-7c9$skfcim9+hl-74nzr@ai7blo'
...
#Agregar apps cuando las vayas creando
INSTALLED_APPS = (
    'django.contrib.auth',
